...
export const DOMAIN_META: Record<Domain, DomainMeta> = {
  native:  { label: 'Native Programmierung',     stroke: '#1565c0', fill: '#e3f2fd', text: '#0d47a1' },
  oo:      { label: 'OO (Managed Runtime)',       stroke: '#2e7d32', fill: '#e8f5e9', text: '#1b5e20' },
  fp:      { label: 'Funktionale Programmierung', stroke: '#e65100', fill: '#fff3e0', text: '#bf360c' },
  special: { label: 'Spezialsprachen',            stroke: '#6a1b9a', fill: '#f3e5f5', text: '#4a148c' },
};
