...
const sidebars: SidebarsConfig = {
  tutorialSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: '3.3. Value Categories and Identity',
        },
        {
          type: 'doc',
          id: 'typsystem/statische-typisierung/intro',
          label: '3.4. Static Typing',
        },
        {
          type: 'doc',
          id: 'typsystem/dynamische-typisierung/intro',
          label: '3.5. Dynamic Typing',
        },
        {
          type: 'doc',
        ...
        },
        {
          ...
          label: '3.7. Generics and Polymorphism',
        },
        {
          type: 'doc',
      ...
      items: [
        {
          ...
          label: '6.1. Conditionals',
        },
        {
          type: 'doc',
          id: 'kontrollfluss/schleifen/intro',
          label: '6.2. Loops and Iteration',
        },
        {
          type: 'doc',
          id: 'kontrollfluss/switch-und-pattern-matching/intro',
          label: '6.3. Switch and Pattern Matching',
        },
        {
          type: 'doc',
          id: 'kontrollfluss/sprunganweisungen/intro',
          label: '6.4. Jump Statements',
        },
      ],
    },
    {
      type: 'category',
      label: '7. Functions and Procedures',
      link: {
        type: 'doc',
        id: 'funktionen/intro',
      },
      items: [
        {
          ...
          label: '7.1. Function Definition',
        },
        {
          type: 'doc',
          id: 'funktionen/funktionsfeatures/intro',
          label: '7.2. Function Features',
        },
        {
          type: 'doc',
          id: 'funktionen/spezielle-funktionstypen/intro',
          label: '7.3. Special Function Types',
        },
      ],
    },
    {
      type: 'category',
      label: '8. Object-Oriented Programming',
      link: {
        type: 'doc',
      ...
      items: [
        {
          ...
          label: '9.1. Core Concepts',
        },
        {
          type: 'doc',
          id: 'fp-konzepte/effektsysteme/intro',
          label: '9.2. Effect Systems',
        },
        {
          type: 'doc',
          id: 'fp-konzepte/formale-methoden/intro',
          label: '9.3. Formal Methods',
        },
      ],
    },
    {
      type: 'category',
      label: '10. Collections and Data Structures',
      link: {
        type: 'doc',
      ...
      items: [
        {
          ...
          label: '13.1. Memory Management Models',
        },
        {
          type: 'doc',
          id: 'speicherverwaltung/speicher-features/intro',
          label: '13.2. Memory Features',
        },
      ],
    },
    {
      type: 'category',
      label: '14. Concurrency and Parallelism',
      link: {
        type: 'doc',
    ...
    {
      type: 'category',
      label: '17. Execution Model, Runtime and Interop',
      link: {
        type: 'doc',
      ...
      items: [
        ...
        },
        {
          ...
          label: '17.4. Interoperability',
        },
        {
          type: 'doc',
          id: 'ausfuehrungsmodell/io-modell/intro',
          label: '17.5. I/O Model',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: '19.2. Scientific Computing',
        },
        {
          type: 'doc',
        ...
        },
        {
          ...
          label: '19.4. Logic and Constraint Programming',
        },
      ],
    },
  ],
